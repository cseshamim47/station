...
public class UserRegistration {
    ...
    public static void userRegistration(User users, Admin admin){
        ...
        for(;;){
            ...
            if(!admin.usernameValidation(username)){ // mil pai taile true : !true = false // !false = true
        ...
        for(;;){
            Utility.academicMsg();
            String academic = scanner.nextLine();
            if(academic.equals("1")){
                users.setAcademic("College / Equivalent");
                System.out.println();
                break;
            }else if(academic.equals("2")){
                users.setAcademic("Undergraduate / Equivalent");
                System.out.println();
                break;
