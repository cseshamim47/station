...
class Gljvvou_Model extends Model{
	...
	public function getSubacc($sub){
		$fields = array();
		$where = "xrecflag='Live' and bizid = ". Session::get('sbizid') ." and xsub = '". $sub ."'";	
	...
	public function getAccountDt($acc){
		$fields = array();
	...
	public function getAccDt($where){
