...
class Singlepresentreport_Model extends Model{
	...
	public function getemplatedetail($selectemp,$selectmonth,$selectyear){
		$fields = array("xfacultyid","(SELECT xname FROM edfaculty WHERE edfaculty.xfacultyid=vempinout.xfacultyid) AS xname", "(Select xoftime from atttime where vempinout.xshift=atttime.xshift) AS xoftime", "xper","xyear","xdate","xshift","xintime","xouttime");
