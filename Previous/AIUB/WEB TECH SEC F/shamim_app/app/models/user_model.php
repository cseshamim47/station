...
class User_Model extends Model{
	...
	public function editUser($data, $usersl){
		$results = array(
			"zemail" => $data['zemail'],
			"zuserfullname" => $data['zuserfullname'],
			"zusermobile" => $data['zusermobile'],
			...
			$where = "xrecflag='Live' and bizid = ". Session::get('sbizid') ." and xusersl = '". $usersl ."'";
	...
	public function getSingleUserByEmail($user){
		$fields = array();
		//print_r($this->db->select("pabuziness", $fields));die;
