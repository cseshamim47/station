...
class Submitbill_Model extends Model{
	...
	public function create($mcols, $mvals, $cols, $vals){
		$mresults = $this->db->insertMultipleDetail('billmst',$mcols,$mvals," ON DUPLICATE KEY UPDATE xdate = VALUES(xdate),xsup = VALUES(xsup),xmobile = VALUES(xmobile),xproject = VALUES(xproject),xcomment = VALUES(xcomment)");
