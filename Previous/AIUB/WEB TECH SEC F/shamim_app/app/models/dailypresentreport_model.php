...
class Dailypresentreport_Model extends Model{
	...
	public function getemplatedetail($date){
		...
		$fields = array("xfacultyid","(SELECT xname FROM edfaculty WHERE edfaculty.xfacultyid=tempatt.xfacultyid) AS xname", "xintime","xouttime", "xdate");
		
		$where ="xdate='".$date."' and attflag='Present'";
