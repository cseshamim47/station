<style>
	...
	.table>thead>tr>th{
		...
		<div class="main-div" style="margin-top:100px;"><div style="text-align:center"><strong align="center" style="border-bottom:1px solid;">Purchase Return</strong></div><table class="table table-bordered" cellspacing="0" width="100%" role="grid" aria-describedby="dtbl_info" style="width: 100%; font-size:12px; margin-top:10px;">
		<tr><td style="background-color:#d8d8d8!important;width: 100px;">Invoice No.</td><td><?php echo $this->pono; ?></td><td style="background-color:#d8d8d8!important;width: 75px;">Supplier ID</td><td><?php echo $this->supid; ?></td><td style="background-color:#d8d8d8!important;width: 85px;">Invoice Date</td><td><?php echo $this->xdate; ?></td></tr>
		<tr><td style="background-color:#d8d8d8!important;">Supplier Name</td><td colspan="3"><?php echo $this->supplier; ?></td><td style="background-color:#d8d8d8!important;">Phone</td><td colspan=""><?php echo $this->supphone; ?></td></tr>
		...
		<tr><td style="background-color:#d8d8d8!important;">Address</td><td colspan="5"><?php echo $this->supadd?></td></tr></table>
				...
				<div>
                    <table class="table table-bordered table-striped">
						<thead>
							<th style="text-align:center">Sl.</th><th style="text-align:center">Item Code</th><th style="text-align:center">Item Name</th><th style="text-align:center">Qty</th><th style="text-align:center">Rate</th><th style="text-align:center">Total</th>
						</thead>
						<tbody>
						<?php foreach($this->vrow as $key=>$val){ ?>
							<tr>
								<td align="center"><?php echo $val['xrow']; ?></td>
								<td>
