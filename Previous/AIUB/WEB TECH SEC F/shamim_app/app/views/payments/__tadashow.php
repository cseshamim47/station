                ...
                <div style="text-align:center;height:10.6in;width:8.3in; margin:0 auto;padding-top:30px">
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td colspan="3"><b>Document Code: HR/03/011</b></td>
                            </tr>
                            <tr>
                                <td colspan="3"><b>TITLE: TA/DA</b></td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <?php $apparray = explode(";", $this->tadamst[0]['xemail']); ?>
                                <td>
                                    
                                    <img style="height: 50px;width: 100px;" src="<?php echo URL;?>images/<?php echo $this->tadamst[0]['zemail'] ?>.png" alt="" />
