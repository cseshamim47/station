<head>
	  ...
	  <link rel="stylesheet" href="<?php echo URL; ?>views/reject/js/EasyAutocomplete/easy-autocomplete.css">
	  <link rel="stylesheet" href="<?php echo URL; ?>views/reject/js/EasyAutocomplete/easy-autocomplete.themes.min.css">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li id="tab-one" class="active"><a href="#tab_1" data-toggle="tab">Reject Entry</a></li>
              <li id="tab-two"><a data-toggle="tab" id="disabled" onclick="loadSOTable('Created');" href="#tab_2">Reject List(Un-Confirmed)</a></li>
              <li id="tab-three"><a href="#tab_3" data-toggle="tab" onclick="loadSOTable2('Confirmed');" >Reject List(Confirmed)</a></li>
            </ul>
...
<div id="row1" class="form-group"><label for="School" class="col-sm-2 control-label"></label><div class="col-sm-12"><div style="Background-color:#00a6cc; color:white"><strong>Reject Details</strong></div></div></div>

<div id="row0" class="form-group">
	<label for="xorg" class="col-sm-2 control-label">Reject No.</label>
	<div class="col-sm-4" style = "margin-top: 7px;"><input type="text" class="form-control input-sm xsonum" id="xsonum" name="xsonum" value="" maxlength="100" placeholder="This Value is created by system">
	</div>
	<label for="xdate" class="col-sm-2 control-label">Date</label>
	<div class="col-sm-4" style = "margin-top: 7px;"><input type="text" value="<?php echo date("d/m/Y")?>" class="form-control input-sm xdate datepicker" id="xdate" name="xdate">
	</div>
</div>
