			...
			<div id="printdiv">
				...
				<div style="float: left;">
					...
					<p>Received Quantity: <?php echo $this->finishedqty; ?></p>
					<p>Cost: <?php echo $this->finishedcost; ?></p>
					<p><strong>Production Raw Material List :</strong></p>
                </div>
				...
				<div>
                    ...
                    <table class="table table-bordered table-striped">
						<thead>
							<th>Sl.</th><th>Itemcode</th><th>Description</th><th style="text-align:right">Consumed Qty</th><th>Unit</th><th style="text-align:right">Cost</th>
						</thead>
						<tbody>
						<?php foreach($this->vrow as $key=>$val){ ?>
							<tr>
								...
								<td align="right"><?php echo $val['xqty']*$this->finishedqty; ?></td>
