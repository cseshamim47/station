 <div class="panel" >
			...
			<?php echo $this->breadcrumb; ?>
				...
				<div style="float: right;width: 33%; text-align:right">
					  <?php if ($this->vrptname=="Receipt Voucher") echo  "Received By_____________";
					  if ($this->vrptname=="Payment Voucher") echo  "Paid By_____________";
					  if ($this->vrptname=="Journal Voucher") echo  "Received / Paid By_____________";
					  ?>
