...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo URL; ?>public/theme/dist/css/AdminLTE.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo URL; ?>public/theme/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page" style="background-image: url('<?php echo URL; ?>public/images/login.jpg')";>