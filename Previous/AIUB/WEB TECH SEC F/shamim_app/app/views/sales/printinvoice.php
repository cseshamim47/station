				...
				<div>
                    <table class="table table-bordered table-striped">
						...
						<tfoot>
							...
							<tr>
								<td colspan="8" align="right"><strong>Prev. Due</strong></td><td align="right"><strong><?php echo $this->cusbal; ?></strong></td>
							</tr>
							<tr>
								<td colspan="8" align="right"><strong>Rcv. Amt</strong></td><td align="right"><strong><?php echo $this->rcvamt; ?></strong></td>
							</tr>
							<?php $xdue = $nettotal-$this->rcvamt+$this->cusbal; ?>
							<tr>
								<td colspan="8" align="right"><strong>Total Due</strong></td><td align="right"><strong><?php echo $xdue; ?></strong></td>
							</tr>
						</tfoot>
					</table>
