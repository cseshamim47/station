<head>
	...
	<link rel="stylesheet" href="<?php echo URL; ?>views/submittada/js/EasyAutocomplete/easy-autocomplete.css">
	<link rel="stylesheet" href="<?php echo URL; ?>views/submittada/js/EasyAutocomplete/easy-autocomplete.themes.min.css">
		...
		<div class="col-md-12">
			...
			<div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					<li id="tab-one" class="active"><a href="#tab_1" data-toggle="tab">TA/DA Entry</a></li>
					<li id="tab-two"><a data-toggle="tab" id="disabled" onclick="loadSOTable('Created');" href="#tab_2">TA/DA List(Un-Confirmed)</a></li>
					<li id="tab-three"><a data-toggle="tab" id="disabled" onclick="loadSOTable('Pending');" href="#tab_3">TA/DA List(Pending)</a></li>
					<li id="tab-four"><a data-toggle="tab" id="disabled" onclick="loadSOTable('Confirmed');" href="#tab_4">TA/DA List(Confirmed)</a></li>
					<li id="tab-five"><a data-toggle="tab" id="disabled" onclick="loadSOTable('Canceled');" href="#tab_5">TA/DA List(Modified)</a></li>
				</ul>
						...
						<form class="form-horizontal" name="dotform" id="dotform" action="" method="post" enctype="multipart/form-data" novalidate="novalidate">
							...
							<div class="">
								<div id="row1" class="form-group"><label for="School" class="col-sm-2 control-label"></label>
									<div class="col-sm-12">
										<div style="Background-color:#00a6cc; color:white"><strong>TA/DA Details</strong></div>
									</div>
								</div>
