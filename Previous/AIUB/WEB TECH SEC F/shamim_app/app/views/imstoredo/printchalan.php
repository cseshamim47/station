			...
			<div id="printdiv">
				...
				<div style="float: left;">
                    <p>Delivery No: <?php echo $this->dono; ?></p>
				...
				<div>
                    <table class="table table-bordered table-striped">
						<thead>
							<th>Sl.</th><th>Itemcode</th><th>Description</th><th style="text-align:right">Qty</th><th>UOM</th><th>Warehouse</th>
						</thead>
						<tbody>
						...
						<tfoot>
							<tr>
								<td colspan="3" align="right"><strong>Total</strong></td><td align="right"><strong><?php echo $this->totqty; ?></strong></td><td></td><td></td>
							</tr>
