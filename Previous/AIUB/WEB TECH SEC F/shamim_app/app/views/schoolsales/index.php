...
<div id="row0" class="form-group">
	...
	<div class="jqueryselect col-sm-4" id="">
		<select class="form-control input-sm whcls" id="codeselect" name="xwh">
			<option value=""></option>
		</select>
		<input type="hidden" id="codetype" value="Warehouse"></div>
...
<div class = "row">
    ...
    <div class = "col-md-12">
        <div class="table-responsive" style="">
			...
			<table class="table table-bordered" cellspacing="0" role="grid" aria-describedby="dtbl_info" style="width:1065px;font-weight:bold;"><tr><td align="right" style="">Sub Total : </td><td style="width:65px; text-align:center;"><span id="subqty">0</span></td><td style="width:137px;text-align:center;"><span id="subtotal">0</span></td></tr></tbody></table>
