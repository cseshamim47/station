<head>
	  ...
	  <link rel="stylesheet" href="<?php echo URL; ?>views/forma/js/EasyAutocomplete/easy-autocomplete.css">
	  <link rel="stylesheet" href="<?php echo URL; ?>views/forma/js/EasyAutocomplete/easy-autocomplete.themes.min.css">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li id="tab-one" class="active"><a href="#tab_1" data-toggle="tab">Forma & Cover Print</a></li>
              <li id="tab-three"><a href="#tab_3" data-toggle="tab" onclick="loadSOTable2('Created');" >All List</a></li>
            </ul>
...
<div id="row1" class="form-group"><label for="School" class="col-sm-2 control-label"></label><div class="col-sm-12"><div style="Background-color:#00a6cc; color:white"><strong>Book Details</strong></div></div></div>

<div id="row0" class="form-group">
	<label for="xsonum" class="col-sm-2 control-label">Order No.</label>
...
<div id="row0" class="form-group">
	...
	<label for="xpress" class="col-sm-2 control-label" style="color:red;">Press Name*</label>
	<div class="col-sm-10"><input type="text" class="form-control input-sm xorg" id="xpress" name="xpress" value="" maxlength="100">
	</div>
</div>
...
<div class = "row">
    ...
    <div class = "col-md-12">
        <div class="table-responsive" style="">
			...
			<table class="table table-bordered" style="display:none" cellspacing="0" role="grid" aria-describedby="dtbl_info" style="width:1065px;font-weight:bold;"><tr><td align="right" style="">Sub Total : </td><td style="width:130px; text-align:center;"><span id="subqty">0</span></td></tr></tbody></table>
