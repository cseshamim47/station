          <div class="header clearfix">		
			<ul class="nav-tabs nav ">
			  ...
			  <li><a data-toggle="tab" id="disabled" href="avascript:void(0)" onclick="loadIframe('helpframe','<?php echo URL;?>supplierpay/solist/Canceled')"><strong>Payment List(Modified)</strong></a></li>
