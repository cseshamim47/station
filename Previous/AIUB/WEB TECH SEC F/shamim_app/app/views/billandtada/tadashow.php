            ...
            <div style="text-align:center;height:10.6in;width:8.3in; margin:0 auto;padding-top:30px">
                <div class="col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="3" align="center"><b>Document Code: HR/03/011</b></td>
                        </tr>
                        <tr>
                            <td colspan="3" align="center"><b>TITLE: TA/DA</b></td>
                        </tr>
                        <tr>
                    ...
                    <table class="ex-table">
                        <tr>
                            <td>Txn No: <?php echo $this->tadamst[0]['xtxnnum'] ?></td>
                            <td>Name: <?php echo $this->tadamst[0]['xsup'] ?></td>
                            <td>Mobile: <?php echo $this->tadamst[0]['xmobile'] ?></td>
                            <td>Project: <?php echo $this->tadamst[0]['xproject'] ?></td>
                            <td>Date: <?php echo date("d/m/Y", strtotime($this->tadamst[0]['xdate'])) ?></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <?php
                            $apparray = explode(";", $this->tadamst[0]['xemail']);
                            ?>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                <?php if (!empty($this->tadamst[0]['paidby']) && $this->tadamst[0]['paidby'] != "") { ?>
                                    <img style="height: 50px;width: 80px;" src="<?php echo URL; ?>images/<?php echo $this->tadamst[0]['paidby'] ?>.png" alt="" />
                                    </br>
                                <?php } else { ?>
                                    </br>
                                    </br>
                            ...
                            <td align="center">
                                <img style="height: 50px;width: 80px;" src="<?php echo URL; ?>images/<?php echo $this->tadamst[0]['zemail'] ?>.png" alt="" />
                                </br>
