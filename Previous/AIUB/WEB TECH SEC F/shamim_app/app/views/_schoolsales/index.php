<head>
	  ...
	  <link rel="stylesheet" href="<?php echo URL; ?>views/schoolsales/js/EasyAutocomplete/easy-autocomplete.css">
	  <link rel="stylesheet" href="<?php echo URL; ?>views/schoolsales/js/EasyAutocomplete/easy-autocomplete.themes.min.css">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li id="tab-one" class="active"><a href="#tab_1" data-toggle="tab">Sales Entry</a></li>
              <li id="tab-two"><a data-toggle="tab" id="disabled" onclick="loadSOTable('Created');" href="#tab_2">Sales List(Un-Confirmed)</a></li>
              <li id="tab-three"><a href="#tab_3" data-toggle="tab" onclick="loadSOTable2('Confirmed');" >Sales List(Confirmed)</a></li>
            </ul>
...
<div id="row1" class="form-group"><label for="School" class="col-sm-2 control-label"></label><div class="col-sm-12"><div style="Background-color:#00a6cc; color:white"><strong>Sales Details</strong></div></div></div>
...
<div id="row0" class="form-group">
	...
	<label for="xquotnum" class="col-sm-2 control-label">Quotation No</label><div class="col-sm-4"><input type="text" class="form-control input-sm xquotnum" id="xquotnum" name="xquotnum" value="" maxlength="50"></div>
</div>
<!-- <div id="row3" class="form-group" style="display:none">

<label for="xcusbal" class="col-sm-2 control-label" style="">Prev. Balance</label>
	<div class="col-sm-4"><input type="text" class="form-control input-sm number" style="" id="xcusbal" name="xcusbal" value="0.00" number="true" minlength="1" maxlength="18" required="" readonly="" aria-required="true"></div>
</div> -->
...
<div id="row2" class="form-group">
	...
	<label for="xsta" class="col-sm-2 control-label">Stationary</label>
	<div class="col-sm-4">
		<div class="clscheck" id="clscheck">
			<label>
				<input class="frmcheck" id="xsta" value="Stationary" type="checkbox">
			</label>
		</div>
	</div>
</div>
...
<!-- <div>
	...
	<input type="button" onclick="getText('300');" />
	<input type="text" id="totext" style="width:500px"/>
</div> -->

<div id="appenddiv"></div>
<div id="appenddivSta"></div>
...
<div id="row6" class="form-group"><label for="xconvertfor" class="col-sm-2 control-label">Convert Rate</label><div class="col-sm-4"><input type="text" class="form-control input-sm number" id="xconvertfor" name="xconvertfor" value="0" number="true" minlength="1" maxlength="18" required="" aria-required="true"></div><label for="xdiscfor" class="col-sm-2 control-label">Discount</label><div class="col-sm-4"><input type="text" class="form-control input-sm number valid" id="xdiscfor" name="xdiscfor" value="0" number="true" minlength="1" maxlength="18" required="" aria-required="true" aria-invalid="false"></div></div>
...
<div class = "row">
    ...
    <div class = "col-md-12">
        <div class="table-responsive" style="">
			...
			<table class="table table-bordered" cellspacing="0" role="grid" aria-describedby="dtbl_info" style="width:1065px;font-weight:bold;"><tr><td align="right" style="">Total Qty : </td><td style="width:65px; text-align:center;"><span id="subqty">0</span></td><td align="right" style="">Sub Total : </td><td style="width:137px;text-align:center;"><span id="subtotal">0</span></td></tr></tbody></table>
			<table style="margin-top:10px" id="StaTable">
			</table>
			<table class="table table-bordered" cellspacing="0" role="grid" aria-describedby="dtbl_info" style="width:1065px;font-weight:bold;"><tr><td align="right" style="">Total Qty: </td><td style="width:65px; text-align:center;"><span id="subqtysta">0</span></td><td align="right" style="">Sub Total : </td><td style="width:137px;text-align:center;"><span id="subtotalsta">0</span></td></tr></tbody></table>


<table style="width:50%; margin-top:20px; font-size:16px;" class="pull-left"  bgcolor="#00FF00">
	<tr>
...
<table style="width:40%; margin-top:20px; font-size:16px;" class="pull-right"  bgcolor="#00FF00">
	<tr>
