...
class Imstorereqapproval extends Controller{
	...
	function __construct(){
		...
		foreach($usersessionmenu as $menus){
				if($menus["xsubmenu"]=="Store Requisitions")
					$iscode=1;							
		}
		...
		$this->view->js = array('public/js/datatable.js','public/js/printjs.js','views/glrpt/js/getaccdt.js','views/imstorereqapproval/js/codevalidator.js');
	...
	function renderTable($branch=""){
		...
		$row = $this->model->getStoreReq($appstatus);
		//print_r($row); die;
