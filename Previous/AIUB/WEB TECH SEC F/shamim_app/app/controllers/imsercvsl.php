...
class Imsercv extends Controller{
	...
	function __construct(){
		...
		$this->fields = array(array(
				...
				"xitemcode-text"=>'Item Code_maxlength="20"'
				),
				array(
				...
				,
				array(
				"xitemdesc-text"=>'Item Description_maxlength="250"',
				"xuom-select_UOM"=>'UOM_maxlength="250" required'
				),
				array(
				...
				array(
				"xstdprice-text_number"=>'Price_number="true" minlength="1" maxlength="18" required',
				"xstdcost-text_number"=>'Cost_number="true" minlength="1" maxlength="18" required'
				)
			);
		...
		public function saveimsercv(){
			...
			if(!isset($_POST['prefix'])){
				...
				$itemcode = $this->model->getItemCode();
				try{
