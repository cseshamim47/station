<?php
class Tadarpt extends Controller{
	...
	function __construct(){
		...
		foreach($usersessionmenu as $menus){
				if($menus["xsubmenu"]=="TA/DA Reports")
					$iscode=1;				
		}
		if($iscode==0)
		...
		public function index(){
			$this->view->rendermainmenu('tadarpt/index');
		}
		...
		function porptmenu(){
			...
			$menuarr = array(
			0 => array("Date wise TA/DA"=>URL."tadarpt/datewisebill","Project wise TA/DA"=>URL."tadarpt/prowisebill"),
			...
			$this->view->renderpage('tadarpt/porptmenu', false);
		}
		...
		function datewisebill(){
			...
			$this->view->breadcrumb = '<ul class="breadcrumb">
							<li><a href="'.URL.'tadarpt/porptmenu">TA/DA Reports</a></li>
							<li class="active">Report Filter</li>
						   </ul>';
			$btn = array(
				"Clear" => URL."tadarpt/datewisebill",
			);	
			$dt = date("Y/m/d");
			...
			$values = array(
				...
				$this->view->dynform = $dynamicForm->createFourColumnFormGen($fields, URL."tadarpt/showdatewisebill", "Show Report",$values);
				
				$this->view->table = "";
				
				$this->view->renderpage('tadarpt/porptfilter', false);
		...
		public function showdatewisebill(){
			...
			$this->view->breadcrumb = '<ul class="breadcrumb">
							<li><a href="'.URL.'tadarpt/porptmenu">TA/DA Reports</a></li>
							<li><a href="'.URL.'tadarpt/datewisebill">Report Filter Form</a></li>
			...
			$this->view->renderpage('tadarpt/reportpage');
		}
		...
		function prowisebill(){
			...
			$values = array(
				...
				$this->view->dynform = $dynamicForm->createFourColumnFormGen($fields, URL."tadarpt/showprowisebill", "Show Report",$values);
		...
		public function showprowisebill(){
			...
			$this->view->breadcrumb = '<ul class="breadcrumb">
							<li><a href="'.URL.'tadarpt/porptmenu">TA/DA Reports</a></li>
							<li><a href="'.URL.'tadarpt/prowisebill">Report Filter Form</a></li>
							<li class="active">TA/DA List</li>
						   </ul>';
			...
			$this->view->org=Session::get('sbizlong');
			$tblsettings = array(
				"columns"=>array(0=>"Txn No","1"=>"Name","2"=>"Date","3"=>"Description",4=>"By",5=>"Day",6=>"Person",7=>"Amount"),
				"groupfield"=>"Project~xproject",
				"grouprecords"=>array(), //database records columns to show in group
				"detailsection"=>array("xtxnnum","xsup","xdate","xdesc","xby~center","xday~center","xperson~center","xamount~center"),
				//"buttons"=>array("Show"=>URL."test/","Delete"=>URL."test/"),
				//"urlvals"=>array("id","phone"),
		...
		function catwisebill(){
			...
			$values = array(
				...
				$this->view->dynform = $dynamicForm->createFourColumnFormGen($fields, URL."tadarpt/showcatwisebill", "Show Report",$values);
		...
		public function showcatwisebill(){
			...
			$this->view->breadcrumb = '<ul class="breadcrumb">
							<li><a href="'.URL.'tadarpt/porptmenu">TA/DA Reports</a></li>
							<li><a href="'.URL.'tadarpt/catwisebill">Report Filter Form</a></li>
							<li class="active">TA/DA List</li>
						   </ul>';
