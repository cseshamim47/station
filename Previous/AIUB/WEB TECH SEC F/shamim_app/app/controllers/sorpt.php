...
class Sorpt extends Controller{
	...
	function __construct(){
		...
		function sorptmenu(){
			...
			// $menuarr = array(
			// 	0 => array("Date wise Sales Order"=>URL."sorpt/datewiseso","Item wise Sales Order"=>URL."sorpt/itemwiseso","Customerwise Sales Order"=>URL."sorpt/cuswiseso","Mobile Order Retailer"=>URL."sorpt/retailerorder",),
			...
			// 	1 => array("Employee Touched Point"=>URL."sorpt/toucedcus")
				
			// 	);
			$menuarr = array(
			0 => array("Date wise Sales Order"=>URL."sorpt/datewiseso","Item wise Sales"=>URL."sorpt/itemsales","Customerwise Sales Order"=>URL."sorpt/cuswiseso")
		...
		public function showdatewiseso(){
			...
			$this->view->org=Session::get('sbizlong');
			$tblsettings = array(
				"columns"=>array("0"=>"Salese Order","1"=>"Customer","2"=>"Name/Org","3"=>"Item Code",4=>"Item Name",5=>"Qty",6=>"Rate",7=>"Convt",8=>"Total Dis.",9=>"N.Price",10=>"Total"),
				"groupfield"=>"Date~xdate",
				"grouprecords"=>array(), //database records columns to show in group
				"detailsection"=>array("xsonum","xcus","xorg","xitemcode","xitemdesc","xqty~center","xrate~center","xexch~center","xdisc~center","nprice~center","xtotal~center"),
				//"buttons"=>array("Show"=>URL."test/","Delete"=>URL."test/"),
				//"urlvals"=>array("id","phone"),
				"sumfields"=>array("xdisc","xqty","xtotal"),
				);
			$table = new ReportingTable();
			$this->view->table = $table->SingleGroupReportingtbl($tblsettings, $tblvalues);
		...
		public function showitemwiseso(){
			...
			$tblsettings = array(
				...
				"grouprecords"=>array("Item Name~xitemdesc"),
		...
		public function showitemsales(){
			...
			$this->view->vfdate = $fdt;
			$this->view->vtdate = $tdt;
			$this->view->vrptname = "Item Sales Report";
			$this->view->tabletitle = "Item Code : ".$xitemcode.", </br>Item Name : ".$xdesc;;
			$this->view->org=Session::get('sbizlong');
			$tblsettings = array(
				"columns"=>array("0"=>"Invoice","1"=>"Name/Org","2"=>"Qty","3"=>"Cost","4"=>"Price","5"=>"S.Price","6"=>"Total Sales","7"=>"Net Profit","8"=>"Total Profit"),
				"groupfield"=>"Date~xdate",
				"grouprecords"=>array(), //database records columns to show in group
				"detailsection"=>array("xsonum~left","xorg~left","xqty~center","xcost~center","xrate~center","netprice~center","xtotalprice~center","xprofit~center","xnetprofit~center"),
				//"buttons"=>array("Show"=>URL."test/","Delete"=>URL."test/"),
				//"urlvals"=>array("id","phone"),
				"sumfields"=>array("xqty","xtotalprice","xnetprofit","xavgprofit"),
				);
			$table = new ReportingTable();
			$this->view->table = $table->SingleGroupReportingtblForItem($tblsettings, $tblvalues);
		...
		public function showcuswiseso(){
			...
			$this->view->vfdate = $fdt;
			$this->view->vtdate = $tdt;
			$this->view->vrptname = "Customer Wise Sales Order";
			$this->view->tabletitle = "Customer ID : ".$cus.", </br>Name/Org : ".$org;
			$this->view->org=Session::get('sbizlong');
			$tblsettings = array(
				"columns"=>array(0=>"Order No",1=>"Item Code",2=>"Item Name",3=>"Qty",4=>"Rate",5=>"Convt",6=>"N.Disc",7=>"N.Price",8=>"Total"),
				"groupfield"=>"Date~xdate",
				"grouprecords"=>array(),
				"detailsection"=>array("xsonum","xitemcode","xitemdesc","xqty~center","xrate~center","xexch~center","xdisc~center","nprice~center","xtotal~center"),
		...
		public function showdealerorder(){
			...
			$this->view->org=Session::get('sbizlong');
			$tblsettings = array(
				"columns"=>array("0"=>"Order Number","1"=>"Customer","2"=>"Name/Org","3"=>"Item Code",4=>"Item Name",5=>"Rate",6=>"Qty",7=>"Total"),
				//"buttons"=>array("Show"=>URL."test/","Delete"=>URL."test/"),
				//"urlvals"=>array("id","phone"),
