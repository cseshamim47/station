...
public class Student implements CourseOperation // inheritance
{
	//student has courses
	
	private String name ; // encapsulation
    private String sid ;
    private Course courses[] = new Course [100] ; // association
	// student has many courses -- association
	...
	int count = 0 ;
	public void insertCourse(Course c) // dynamic polymorphism
	{
