...
void solve()
{
    ...
    Fo(i,1,n+1)
    {
        ...
        fo(k,n)
        {
            ...
            {   
                // cout << cnt << " ";
                biggerSeg = max(cnt,biggerSeg);
                cnt = 0;
                curSum = 0;
            }

            // cout << targetSum << " " << curSum  << " " << cnt<< endl;
        }
        // cout << i << " " << biggerSeg << " " << targetSum << endl;

        if(ok)
        {
            ans = min(ans,biggerSeg);
        }
    }
    cout << ans << endl;
}
