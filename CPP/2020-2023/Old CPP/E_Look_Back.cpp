...
void solve()
{
    ...
    Fo(i,1,n)
    {
        ...
        k = 0;
        while(aa.size() && dd.size())
        {
            if(aa.front() == dd.front()) 
            {
                bb.push_back(dd.front());
                aa.pop_front();
                dd.pop_front();
            }else if(aa.front() > dd.front())
            {
                k = 1;
                break;
            }else 
