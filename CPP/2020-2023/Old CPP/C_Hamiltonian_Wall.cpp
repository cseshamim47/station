...
void solve()
{
    ...
    {
        char ch = 'A';
        if(pos == 0 && c[1][i] == 'B' && !vis[1][i])
        {
            ch = 'D';
            pos = 1;
            vis[pos][i] = 1;
            cnt--;
        }else if(pos == 1 && c[0][i] == 'B' && !vis[0][i])
        {
            ch = 'U';
            pos = 0;
            vis[pos][i] = 1;
            cnt--;
        }else if(i+1 < m && c[pos][i+1] == 'B')
        {
            ch = 'L';
            vis[pos][i+1] = 1;
            cnt--;
        ...
        if(i+1 < m && i-1 > 0)
        {
            if(c[0][i] == 'B' && c[0][i-1] == 'W' && c[0][i+1] == 'W')
            {
                cnt = INF;
                break;
            }else if(c[1][i] == 'B' && c[1][i-1] == 'W' && c[1][i+1] == 'W')
            {
                cnt = INF;
                break;
            }
        }else if(c[0][i] == 'W' && c[1][i] == 'W')
        {
            cnt = INF;
            break;
        }else if(i+1 < m && c[0][i] == 'W' && c[1][i+1] == 'W')
        {
            cnt = INF;
            break;
        }else if(i+1 < m && c[1][i] == 'W' && c[0][i+1] == 'W')
        {
            cnt = INF;
            break;
        }
