...
void solve()
{
   ...
   ans = abs(v[a-1].F - v[b-1].F) + abs(v[a-1].S-v[b-1].S);
   ...
   fo(i,n)
   {
        ...
        if(i < k)
        {
            t1 = min(t1,abs(v[a-1].F-v[i].F) + abs(v[a-1].S-v[i].S));
            t2 = min(t2,abs(v[i].F-v[b-1].F) + abs(v[i].S-v[b-1].S));
        ...
        ans = min(ans,abs(v[a-1].F-v[i].F) + abs(v[a-1].S-v[i].S) + abs(v[i].F-v[b-1].F) + abs(v[i].S-v[b-1].S));
