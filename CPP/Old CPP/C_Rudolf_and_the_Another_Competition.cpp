...
bool cmp(pair<pair<int,int>,int> a,pair<pair<int,int>,int> b)
{
    ...
    }else if(points1 > points2) return true;
    else return false;
}
...
void solve()
{
    int b=0,i=0,j=0,m=0,n=0,k=0,ans=0,cnt=0,odd=0,even=0,sum=0,l=0,r=0,p=0,q=0;
